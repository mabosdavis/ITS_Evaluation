...
df1 <- read_excel("2020/VMS History Q1 2020.xlsx")
df2 <- read_excel("2020/VMS History Q2 2020.xlsx")
df3 <- read_excel("2020/VMS History Q3 2020.xlsx")
df4 <- read_excel("2020/VMS History Q4 2020.xlsx")
df5 <- read_excel("2020/VMS History Q5 2020.xlsx")
df6 <- read_excel("2020/VMS History Q6 2020.xlsx")
df7 <- read_excel("2020/VMS History Q7 2020.xlsx")

df <- rbind(df1, df2, df3, df4, df5, df6, df7)
rm(df1); rm(df2); rm(df3); rm(df4); rm(df5); rm(df6); rm(df7); 

# rename the columns
names(df)[names(df) == 'DeviceId'] <- 'V.device.id'
...
names(df)[names(df) == 'MsgSourceType'] <- 'V.source.type'
...
df <- df[c("V.device.id", "V.device.location","V.route", "V.bound", 
           "V.mile.post", "V.source.type", "V.source.name", "V.start.time", 
